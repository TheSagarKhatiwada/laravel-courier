...
<div class="py-4">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-lg font-semibold text-gray-700">All Employees <span class="text-gray-400 font-normal text-sm">({{ $employees->total() }})</span></h2>
        <a href="{{ route('employees.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700 font-medium">+ New Employee</a>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <a href="{{ route('employees.show', $employee) }}" class="font-medium text-blue-600 hover:underline">{{ $employee->name }}</a>
                        </td>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex gap-2">
                                <a href="{{ route('employees.show', $employee) }}" class="text-blue-600 hover:underline text-xs">View</a>
                                <a href="{{ route('employees.edit', $employee) }}" class="text-gray-600 hover:underline text-xs">Edit</a>
                            </div>
                        </td>
                    </tr>
                    @empty
